...
const Middle = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-full max-w-7xl font-sarabun rounded-lg overflow-hidden mx-auto relative">
        {/* Left Section */}
      ...
      <div className="flex flex-col lg:hidden w-full max-w-7xl font-sarabun rounded-lg overflow-hidden mx-auto relative">
        {/* Left Section */}
        <div className="bg-[#F9F4F1] p-6 flex items-center">
          <div className="flex flex-col items-center gap-6">
            <div className="bg-[#C49A2E] text-white p-6 rounded-xl text-center">
              <h2 className="text-4xl font-bold">30</h2>
              <p className="text-sm font-bold">OF YEAR<br />Experiences</p>
            </div>
            <h1 className="text-2xl font-bold text-black leading-snug text-center">
              Have A Wide Range Of Logistics Solution Your Next Business.
            </h1>
          </div>
        </div>
        ...
        {/* Right Section */}
        <div className="bg-[#C49A2E] p-6 relative flex flex-col justify-center items-center">
          <div className="flex items-center gap-4 mb-6">
            <span className="text-white text-xl font-sarabun font-semibold">
              <FontAwesomeIcon icon={faFlag} className="mr-2" />Track & Trace
            </span>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 w-full">
            <input
              type="text"
              placeholder="Enter Tracking Number"
              className="p-3 rounded-lg bg-[#A10000] text-white placeholder-white w-full outline-none"
            />
            <button className="p-3 bg-white text-black rounded-lg font-semibold w-full">
              TRACK & TRACE
            </button>
          </div>
