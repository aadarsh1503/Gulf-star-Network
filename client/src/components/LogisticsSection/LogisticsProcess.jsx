  ...
  return (
    ...
    <section className="bg-[#CDA435] relative z-50 h-screen text-white py-16">
      ...
      <div className="text-center mb-12 mt-12">
        <h3 className="text-sm uppercase tracking-wide">How It Works</h3>
        <h2 className="text-4xl font-bold mt-2">How We Operate Unveiling<br /> Our Logistics Process</h2>
      </div>
      <div className="flex justify-center items-center gap-16 flex-wrap">
        {steps.map((step, index) => (
          <div key={step.id} className="flex flex-col items-center text-center relative">
            <div className="relative bg-white rounded-lg p-6 shrink-0 text-black shadow-lg">
              {step.icon}
