...
const About1 = () => {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-between p-8">
      ...
      <div className="relative w-full lg:w-1/2">
        ...
        <motion.img
          ...
          className="absolute bottom-[-30px] left-[230px] border-6 h-[256px] shadow-xl border-white  w-2/4 rounded-xl "
        />
      </div>
      ...
      <div className="lg:w-1/2 mt-10 lg:mt-0">
        ...
        <p className="mt-4 text-gray-600 w-[550px]">
      ...
      {/* Info Box */}
      <div className="bg-Yellow text-white relative right-30 rounded-xl p-9 bottom-4 w-fit">
    ...
    <p className='w-[550px]'>Modeniscing elit. Aliquam vulputate, tortor nec com ultri viverra Suspen disse faucibus sed dolor eget Sed id urna. hiftler Group irepresentatilve loisticsti operator providings.Modeniscing elit. Aliquam vulputate, tortor nec com ultri viverra Suspen disse faucibus sed dolor eget.</p>
      </div>
    </section>
  );
};
